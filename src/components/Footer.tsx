        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm text-gray-300 leading-relaxed">
              Transport premium de marchandises entre le Maroc et la France. Fiabilité, sécurité et délais respectés. Couverture complète du Maroc : Tanger à Laâyoune (Lagouira).
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <a href={`tel:${phone.replace(/\s/g, '')}`} className="flex items-center gap-2 hover:text-moroccan-gold transition-colors">
                <Phone size={16} /> {phone} (Rachid)
              </a>
              <a href={`tel:0752336725`} className="flex items-center gap-2 hover:text-moroccan-gold transition-colors">
                <Phone size={16} /> 0752336725 (Amine)
              </a>
              ...
              <div className="flex items-start gap-2 text-gray-300">
                ...
                <span>Paris, France & Casablanca, Maroc — Tanger à Laâyoune</span>
              </div>
            </div>
          </div>
        </div>
